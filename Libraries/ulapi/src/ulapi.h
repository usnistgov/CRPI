...
//Added by Meg so that ulapi will work with CRPI
#ifndef LIBRARY_API
#if defined(_MSC_VER)
...
/*! Returns a real-valued number of seconds wiith respect
  ...
  program. */
extern LIBRARY_API ulapi_real ulapi_time(void);
...
*/
extern LIBRARY_API const char *ulapi_time_string(char *dst, size_t size);

/*! Puts the calling thread to sleep for a period of \a secs seconds. */
extern LIBRARY_API void ulapi_sleep(ulapi_real secs);

/*! Puts the application to sleep indefinitely until a signal */
extern LIBRARY_API ulapi_result ulapi_app_wait(void);
...
/*!
  ...
  recognized.
*/
extern LIBRARY_API ulapi_result ulapi_init(void);
extern LIBRARY_API ulapi_result ulapi_exit(void);

extern LIBRARY_API ulapi_integer ulapi_to_argv(const char *str, char ***argv);
extern LIBRARY_API void ulapi_free_argv(ulapi_integer argc, char **argv);
...
extern LIBRARY_API void ulapi_set_debug(ulapi_integer mask);
...
extern LIBRARY_API ulapi_prio ulapi_prio_highest(void);
extern LIBRARY_API ulapi_prio ulapi_prio_lowest(void);
extern LIBRARY_API ulapi_prio ulapi_prio_next_higher(ulapi_prio prio);
extern LIBRARY_API ulapi_prio ulapi_prio_next_lower(ulapi_prio prio);
...
extern LIBRARY_API ulapi_result ulapi_task_init(ulapi_task_struct *task);
extern LIBRARY_API ulapi_task_struct *ulapi_task_new(void);
extern LIBRARY_API ulapi_result ulapi_task_clear(ulapi_task_struct *);
extern LIBRARY_API ulapi_result ulapi_task_delete(ulapi_task_struct *task);

typedef void (*ulapi_task_code)(void *);

extern LIBRARY_API ulapi_result ulapi_task_start(ulapi_task_struct *task,
				     void (*taskcode)(void *),
				     void *taskarg,
				     ulapi_prio prio,
				     ulapi_integer period_nsec);

extern  LIBRARY_API ulapi_result ulapi_task_stop(ulapi_task_struct *);
extern LIBRARY_API ulapi_result ulapi_task_pause(ulapi_task_struct *);
extern LIBRARY_API ulapi_result ulapi_task_resume(ulapi_task_struct *);
extern LIBRARY_API ulapi_result ulapi_task_set_period(ulapi_task_struct *, ulapi_integer period_nsec);
extern LIBRARY_API ulapi_result ulapi_self_set_period(ulapi_integer period_nsec);
extern LIBRARY_API ulapi_result ulapi_wait(ulapi_integer period_nsec);

/*!
  Terminates the calling task, saving \a retval for later reference by
  a task that may call \a ulapi_task_join.
*/
extern LIBRARY_API void ulapi_task_exit(ulapi_integer retval);

/*!
  Suspends the caller until the \a task has exited, copying that task's
  exit value into \a retval if \a retval is not NULL.
*/
extern LIBRARY_API ulapi_result ulapi_task_join(ulapi_task_struct *, ulapi_integer *retval);
extern LIBRARY_API ulapi_integer ulapi_task_id(void);

/*!
  Allocates a new process handle.
*/
extern LIBRARY_API void *ulapi_process_new(void);
/*!
  Removes storage allocated for a process identifier or handle.
*/
extern LIBRARY_API ulapi_result ulapi_process_delete(void *proc);
/*!
  Executes the program and its args as in the \a path string.
  \a proc is the already-created handle from ulapi_process_new.
 */
extern LIBRARY_API ulapi_result ulapi_process_start(void *proc, char *path);
extern LIBRARY_API ulapi_result ulapi_process_stop(void *proc);
/*! Returns non-zero the process is done, otherwise returns zero */
extern LIBRARY_API ulapi_integer ulapi_process_done(void *proc, ulapi_integer *result);
extern ulapi_result ulapi_process_wait(void *proc, ulapi_integer *result);

/*! Initializes a mutex with the key provided. */
extern LIBRARY_API ulapi_result ulapi_mutex_init(ulapi_mutex_struct *mutex, ulapi_id key);
...
/*!
  ...
  be created.
*/
extern LIBRARY_API ulapi_mutex_struct *ulapi_mutex_new(ulapi_id key);
...
/*! Deletes the mutex. */
extern LIBRARY_API ulapi_result ulapi_mutex_delete(ulapi_mutex_struct *mutex);

/*| Releases the mutex, signifying that the associated shared resource 
  is now free for another task to take. */
extern LIBRARY_API ulapi_result ulapi_mutex_give(ulapi_mutex_struct *mutex);
...
extern LIBRARY_API ulapi_result ulapi_mutex_take(ulapi_mutex_struct *mutex);

extern LIBRARY_API void *ulapi_sem_new(ulapi_id key);
extern LIBRARY_API ulapi_result ulapi_sem_delete(void *sem);
extern LIBRARY_API ulapi_result ulapi_sem_give(void *sem);
extern LIBRARY_API ulapi_result ulapi_sem_take(void *sem);
...
*/
extern LIBRARY_API void *ulapi_cond_new(ulapi_id key);

/*! Deletes the condition variable. */
extern LIBRARY_API ulapi_result ulapi_cond_delete(void *cond);

/*| Signals that the condition variable has reached its release value */
extern LIBRARY_API ulapi_result ulapi_cond_signal(void *cond);

/*| Broadcasts that the condition variable has reached its release value */
extern LIBRARY_API ulapi_result ulapi_cond_broadcast(void *cond);

/*! Waits until the condition variable has reached its release value */
extern LIBRARY_API ulapi_result ulapi_cond_wait(void *cond, void *mutex);
...
*/
extern LIBRARY_API void *ulapi_shm_new(ulapi_id key, ulapi_integer size);
/*!
 ...
 */
extern LIBRARY_API void *ulapi_shm_addr(void *shm);
/*!
  Deletes shared memory previously allocated with \a ulapi_shm_new.
 */
extern LIBRARY_API ulapi_result ulapi_shm_delete(void *shm);
...
*/
extern LIBRARY_API void *ulapi_rtm_new(ulapi_id key, ulapi_integer size);

/*!
  Returns a pointer to the actual RT memory, given a RT memory
  data structure previously created with \a ulapi_shm_new.
 */
extern LIBRARY_API void *ulapi_rtm_addr(void *shm);
/*!
  Deletes RT memory previously allocated with \a ulapi_shm_new.
 */
extern LIBRARY_API ulapi_result ulapi_rtm_delete(void *shm);
...
*/
extern LIBRARY_API ulapi_integer ulapi_socket_get_client_id(ulapi_integer port, const char *host);
extern LIBRARY_API ulapi_integer ulapi_socket_get_client_id_on_interface(ulapi_integer port, const char *hostname, const char *intf);
...
*/
extern LIBRARY_API ulapi_integer ulapi_socket_get_server_id(ulapi_integer port);
/*! Equivalent to ulapi_socket_get_server_id but with a specified interface. */
extern LIBRARY_API ulapi_integer ulapi_socket_get_server_id_on_interface(ulapi_integer port, const char *intf);

/*!
  Called by a server to gets a connection from a client. Returns the
  integer socket descriptor for later sends and receives.
*/
extern LIBRARY_API ulapi_integer ulapi_socket_get_connection_id(ulapi_integer id);

extern LIBRARY_API ulapi_result ulapi_getpeername(ulapi_integer id, char *ipstr, size_t iplen, ulapi_integer *port);

/*!
  Gets an fd for broadcast writing.
*/
extern LIBRARY_API ulapi_integer ulapi_socket_get_broadcaster_id(ulapi_integer port);
/*! Equivalent to ulapi_socket_get_broadcaster_id but with a specified interface. */
extern LIBRARY_API ulapi_integer ulapi_socket_get_broadcaster_id_on_interface(ulapi_integer port, const char *intf);

/*!
  Gets an fd for broadcast reading.
*/
extern LIBRARY_API ulapi_integer ulapi_socket_get_broadcastee_id(ulapi_integer port);
/*! Equivalent to ulapi_socket_get_broadcastee_id but with a specified interface. */
extern LIBRARY_API ulapi_integer ulapi_socket_get_broadcastee_id_on_interface(ulapi_integer port, const char *intf);
 ...
 */
extern LIBRARY_API ulapi_integer ulapi_socket_get_multicaster_id(ulapi_integer port);
/*!
  Equivalent to ulapi_socket_get_multicaster_id but with a specified interface group.
 */
extern LIBRARY_API ulapi_integer ulapi_socket_get_multicaster_id_on_interface(ulapi_integer port, const char *intf);
/*!
  Gets an fd for multicast reading.
*/
extern LIBRARY_API ulapi_integer ulapi_socket_get_multicastee_id(ulapi_integer port);
/*!
  Equivalent to ulapi_socket_get_multicastee_id but with a specified interface group. */
extern LIBRARY_API ulapi_integer ulapi_socket_get_multicastee_id_on_interface(ulapi_integer port, const char *intf);

/*!
  Sets the socket to be blocking or nonblocking.
*/
extern LIBRARY_API ulapi_result ulapi_socket_set_nonblocking(ulapi_integer id);
extern LIBRARY_API ulapi_result ulapi_socket_set_blocking(ulapi_integer id);

extern LIBRARY_API char *ulapi_address_to_hostname(ulapi_integer address);
extern LIBRARY_API ulapi_integer ulapi_hostname_to_address(const char *hostname);
extern LIBRARY_API ulapi_integer ulapi_get_host_address(void);

/*!
  Reads up to \a len bytes from socket \a id into \a buf. Returns the
  number of bytes read, or -1 on error.
 */
extern LIBRARY_API ulapi_integer ulapi_socket_read(ulapi_integer id, char *buf, ulapi_integer len);

/*!
  Writes \a len bytes from \a buf to socket \a id. Returns the
  number of bytes written, or -1 on error.
 */
extern LIBRARY_API ulapi_integer ulapi_socket_write(ulapi_integer id, const char *buf, ulapi_integer len);

/*!
  Broadcasts \a len bytes from \a buf to socket \a id using port -a
  port. Returns the number of bytes written, or -1 on error.
 */
extern LIBRARY_API ulapi_integer ulapi_socket_broadcast(ulapi_integer id, ulapi_integer port, const char *buf, ulapi_integer len);

/*!
  Closes the socket id, whether that for a client, for a server, or to
  a client, broadcast or otherwise.
 */
extern LIBRARY_API ulapi_result ulapi_socket_close(ulapi_integer id);
...
extern LIBRARY_API void *
ulapi_fd_new(void);

/*! Deallocates a previously allocated file identifier. */
extern LIBRARY_API ulapi_result
 ...
 */
extern LIBRARY_API ulapi_integer
...
extern LIBRARY_API void ulapi_fd_flush(void *id);

/*! Drains the file descriptor \a id. */
extern LIBRARY_API void ulapi_fd_drain(void *id);
...
/*!
  ...
  into it.
*/
extern LIBRARY_API void *ulapi_dl_open(const char *objname, char *errstr, int errlen);

/*!
  Closes a shared library handle previously returned by ulapi_dl_open.
*/
extern LIBRARY_API void ulapi_dl_close(void *handle);
...
*/
extern LIBRARY_API void *ulapi_dl_sym(void *handle, const char *name, char *errstr, int errlen);
...
*/
extern LIBRARY_API ulapi_result ulapi_system(const char *prog, ulapi_integer *result);
...
*/
extern LIBRARY_API ulapi_result ulapi_sxprintf(char **buffer, size_t *buffer_size, const char *fmt, ...);

/*!
  Concatenates string in \a src to that in \dst, growing \a dest if needed and updating its \a dst_size.
*/
extern LIBRARY_API int ulapi_strxcat(char **dst, size_t *dst_size, const char *src);
...
*/
extern LIBRARY_API ulapi_flag ulapi_ispath(const char *path);

extern LIBRARY_API char *ulapi_fixpath(const char *path, char *fix, size_t len);
extern LIBRARY_API char *ulapi_basename(const char *path, char *base);
extern LIBRARY_API char *ulapi_dirname(const char *path, char *dir);
...
extern LIBRARY_API int	opterr;
extern LIBRARY_API int	optind;
extern LIBRARY_API int	optopt;
extern LIBRARY_API char    *optarg;
extern LIBRARY_API int	optreset;

extern LIBRARY_API int getopt(int nargc, char * const *nargv, const char *options);

extern LIBRARY_API int getopt_long(int nargc, char * const * nargv, const char * options, const struct option * long_options, int * idx);
